...
begin
  ...
  OnDebugStart(DebugEv.CreateProcessInfo.hFile);
...
begin
  ...
  begin
    ...
    OnHardwareBreakpoint(hThread, BPA, C);
...
procedure TDebuggerCore.SetBreakpoint(Address: NativeUInt; BType: THWBPType);
var
  T: THandle;
begin
